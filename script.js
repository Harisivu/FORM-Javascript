...
function validateInputs(){
    ...
    else if(PhotoVal==='.jpeg'){
        success=false;
        setError(Photo,'only jpg and png allow')
    }
    else{
         setSuccess(Photo)
    }
...
form.addEventListener('submit', function(event) {
            ...
            if (inputDate > currentDate) {
                message.textContent = "The date is in the future!";
                message.style.color = 'red';
            } else {
                message.textContent = "The date is valid.";
